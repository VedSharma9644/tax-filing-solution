...
const Sidebar = ({ isExpanded, activePage, toggleSidebar }) => {
  const menuItems = [
    ...
    { path: '/applications', icon: 'applications', label: 'Applications' },
    { path: '/payments', icon: 'payments', label: 'Payments' },
    { path: '/scheduled-calls', icon: 'scheduled-calls', label: 'Scheduled Calls' },
    { path: '/feedbacks', icon: 'feedbacks', label: 'FeedBacks' },
    { path: '/support-requests', icon: 'support-requests', label: 'Support Requests' }
  ];
